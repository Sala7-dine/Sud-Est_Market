<nav class="navbar navbar-fixed-top">
        <div class="container-fluid">
            ...
            <div class="navbar-right">
                ...
                <div id="navbar-menu">
                    <ul class="nav navbar-nav d-flex align-item-center flex-row">
                        <li>
                        ...
                        <li class="dropdown">
                            <a href="javascript:void(0);" class="dropdown-toggle icon-menu mb-2" data-toggle="dropdown"><i class="icon-equalizer"></i></a>
