                ...
                <div class="tab-pane active" id="admin">
                    <nav class="sidebar-nav">
                        <ul class="main-menu metismenu">
                            ...
                            <li><a href="javascript:void(0);" class="has-arrow"><i class="icon-picture"></i><span>Banner Managment</span> </a>
                                <ul>
                            ...
                            <li><a href="app-inbox.html"><i class="icon-layers"></i>Order Mnagement</a></li>
