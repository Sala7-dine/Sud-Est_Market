        ...
        <div class="block-header">
            <div class="row">
                <div class="col-lg-6 col-md-8 col-sm-12">
                    ...
                    <a href="{{route('brand.create')}}" class="btn btn-sm btn-outline-secondary"><i class="icon-plus"></i> Create Brand</a>
                </h2>
                    <ul class="breadcrumb">
            ...
            <div class="col-lg-12">
                <div class="card">
                    <div class="header">
                        ...
                        <p class="mt-2 float-left">Total Brands : {{\App\Models\Brand::count()}}</p>
                            ...
                            <table class="table table-bordered table-striped table-hover js-basic-example dataTable">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <a href="{{route('brand.edit' , $item->id )}}" data-toggle="tootltip" title="edit" data-placement="bottom" class="float-left btn btn-sm btn-outline-warning"> <i class="fas fa-edit"></i> </a>
