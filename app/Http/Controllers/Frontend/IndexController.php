...
class IndexController extends Controller
{
    ...
    {
        $user = User::where("id", $id)->update(["address" => $request->address, "country" => $request->country, "city" => $request->city, "postcode" => $request->postcode, "state" => $request->state]);
        if ($user) {
    ...
    {
        $user = User::where("id", $id)->update(["saddress" => $request->saddress, "scountry" => $request->scountry, "scity" => $request->scity, "spostcode" => $request->spostcode, "sstate" => $request->sstate]);
        if ($user) {
